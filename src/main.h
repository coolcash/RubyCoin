...
/** Default for -orphanblocks, maximum memory used for orphan blocks */
...
inline bool IsProtocolV2(int nHeight) { return nHeight > 7000; }
inline bool IsProtocolV3(int64_t nTime) { return TestNet() || nTime > 1446879600; }
