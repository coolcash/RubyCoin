...
#if defined(NDEBUG)
# error "Rubycoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Rubycoin Signed Message:\n";
...
{
    size_t nMaxOrphanBlocksSize = GetArg("-orphanblocks", DEFAULT_MAX_ORPHAN_BLOCKS) * ((size_t) 1 << 20);
...
void static ProcessGetData(CNode* pfrom)
{
    ...
    while (it != pfrom->vRecvGetData.end()) {
        ...
        const CInv &inv = *it;
        {
		    ...
		    // Previous versions could accept signatures with high-S
